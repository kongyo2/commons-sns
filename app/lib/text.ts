...
// DEL + C1 controls (U+007F-009F), zero-width / word-joiner characters
// (U+200B-200F, U+2060, U+FEFF) and bidi overrides / isolates (U+202A-202E,
// U+2066-2069).  Stripped in every mode.
const INVISIBLE_CLASS =
  codeRange(0x007f, 0x009f) +
  codeRange(0x200b, 0x200f) +
  codePoint(0x2060) +
  codePoint(0xfeff) +
  codeRange(0x202a, 0x202e) +
  codeRange(0x2066, 0x2069);

// Single-line strips every C0 control (including TAB and LF); multiline keeps TAB
// (U+0009) and LF (U+000A) so paragraph breaks survive.
